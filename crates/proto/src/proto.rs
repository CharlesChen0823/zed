...
messages!(
    ...
    (CallHierarchyIncomings, Background),
    (CallHierarchyIncomingsResponse, Background),
    (CallHierarchyOutgoings, Background),
    (CallHierarchyOutgoingsResponse, Background),
...
request_messages!(
    ...
    (CallHierarchyIncomings, CallHierarchyIncomingsResponse),
    (CallHierarchyOutgoings, CallHierarchyOutgoingsResponse),
...
entity_messages!(
    ...
    CallHierarchyIncomings,
    CallHierarchyOutgoings,
    RefreshInlayHints,
    RefreshCodeLens,
    ReloadBuffers,
