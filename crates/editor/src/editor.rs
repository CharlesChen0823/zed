                ...
                match direction {
                    Direction::Next => {
                        ...
                        for (start_offset, query_match) in query_matches {
                            ...
                            let offset_range = start_offset + query_match.start()
                                ..start_offset + query_match.end();
            ...
            if only_carets {
                ...
                if selections.len() == 1 {
                    ...
                    let query = match direction {
                        ...
                        Direction::Prev => query.chars().rev().collect::<String>(),
                    };
                ...
                let query = match direction {
                    Direction::Next => selected_text,
                    Direction::Prev => selected_text.chars().rev().collect::<String>(),
                };
